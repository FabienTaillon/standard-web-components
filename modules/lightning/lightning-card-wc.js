...
var stylesheet0$2 = [stylesheet$3];
...
var stylesheet1$2 = [stylesheet$2];

var stylesheet0$1 = [stylesheet0$2, stylesheet1$2];
...
var stylesheet1 = [stylesheet0$2, stylesheet1$1];

var iconStylesheets = [stylesheet0, stylesheet1];
      ...
      case 'utility':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesUtilityRtl-JYogB-8e.js');
          return Lib;
        }
      case 'action':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesActionRtl-Lkw6OYwE.js');
          return Lib;
        }
      case 'standard':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesStandardRtl-ClaxDgaI.js');
          return Lib;
        }
      case 'doctype':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesDoctypeRtl-iTRnzRI-.js');
          return Lib;
        }
      case 'custom':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesCustomRtl-EiaUf7Yp.js');
          return Lib;
        }
      default:
        return null;
      ...
      case 'utility':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesUtility-kGbErzJ3.js');
          return Lib;
        }
      case 'action':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesAction-jTIXYDNQ.js');
          return Lib;
        }
      case 'standard':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesStandard-ZDGGKJT7.js');
          return Lib;
        }
      case 'doctype':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesDoctype-lv0RF8AN.js');
          return Lib;
        }
      case 'custom':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesCustom-AhTIVkoZ.js');
          return Lib;
        }
      default:
        return null;
...
function tmpl$1($api, $cmp, $slotset, $ctx) {
  ...
  return [api_element("span", {
    ...
    key: 1
  }), $cmp.alternativeText ? api_element("span", stc1$1, [api_text(api_dynamic_text($cmp.alternativeText))]) : null])];
  /*LWC compiler v6.0.0*/
}
...
tmpl$1.stylesheetToken = "lwc-4897l11qtae";
tmpl$1.legacyStylesheetToken = "lightning-icon_icon";
 ...
 */
class LightningIcon extends LightningShadowBaseClass$1 {
  constructor(...args) {
    super(...args);
    this._src = void 0;
...
tmpl.legacyStylesheetToken = "lightning-card_card";
freezeTemplate(tmpl);
 ...
 */
class LightningCard extends LightningShadowBaseClass$1 {
  constructor(...args) {
    super(...args);
    /**
...
var LightningCard$1 = registerComponent(LightningCard, {
  tmpl: _tmpl,
  sel: "lightning-card",
  apiVersion: 61
});

customElements.define('lightning-card', LightningCard$1.CustomElementConstructor);
