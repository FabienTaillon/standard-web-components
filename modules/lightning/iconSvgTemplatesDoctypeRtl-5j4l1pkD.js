...
var doctype_gpres = registerTemplate(tmpl$r);
tmpl$r.stylesheets = [];
tmpl$r.stylesheetToken = "lwc-5kn1orgdftn";
tmpl$r.legacyStylesheetToken = "buildTemplates-doctype_gpres";
freezeTemplate(tmpl$r);

const $fragment1$q = parseSVGFragment`<g${3}><path fill="#3ba755" d="M51 0A50 50 0 001 51v538a50 50 0 0050 51h458c28 0 51-23 51-51V203L371 0z"${3}/><path fill="#fff" d="M101 375v164h215V375zm150 115h50v35h-50zm0-50h50v35h-50zm0-51h50v36h-50zM115 490h122v35H115zm0-50h122v35H115zm0-51h122v36H115z"${3}/><path fill="#22683e" d="M560 203v10H432s-63-12-61-67c0 0 2 57 60 57z"${3}/><path fill="#cdefc4" d="M371 0v145c0 17 11 58 61 58h128z"${3}/></g>`;
...
var doctype_keynote = registerTemplate(tmpl$n);
tmpl$n.stylesheets = [];
tmpl$n.stylesheetToken = "lwc-6bnaf3c2f4o";
tmpl$n.legacyStylesheetToken = "buildTemplates-doctype_keynote";
freezeTemplate(tmpl$n);

const $fragment1$m = parseSVGFragment`<g${3}><path fill="#032d60" d="M515 155c25 0 45 20 45 45v310c0 25-20 45-45 45H45a45 45 0 01-45-45V130c0-25 20-45 45-45h115c38 0 42 12 67 45 21 27 72 25 104 25h184z"${3}/><path fill="#90d0fe" d="M515 181H92a45 45 0 00-45 45v29l45-65h423l45 65v-29c0-25-20-45-45-45z"${3}/><path fill="#1ab9ff" d="M46 555h469c25 0 45-20 45-45V235c0-25-20-45-45-45H93a45 45 0 00-46 44v283c0 13-10 23-23 23a23 23 0 01-23-23 45 45 0 0045 38z"${3}/><path fill="#fff" d="M255 378h36v115h-36zm61 0h36v115h-36zm148-60l-150-62c-4-2-7-3-11-3-1 0-5 0-11 3l-150 62c-3 2-5 5-5 8v9c0 5 4 9 9 9h29v140c0 5 4 9 9 9h45V378h-18c-4 0-6-2-6-6v-12c0-4 2-6 6-6h183c4 0 6 2 6 6v12c0 4-2 6-6 6h-18v115h45c5 0 9-4 9-9V344h29c5 0 9-4 9-9v-8c1-4-1-7-4-9zm-161 5a19 19 0 110-38 19 19 0 010 38z"${3}/></g>`;
...
var doctype_psd = registerTemplate(tmpl$e);
tmpl$e.stylesheets = [];
tmpl$e.stylesheetToken = "lwc-5hdtfb0b9n7";
tmpl$e.legacyStylesheetToken = "buildTemplates-doctype_psd";
freezeTemplate(tmpl$e);

const $fragment1$d = parseSVGFragment`<g${3}><path fill="#0176d3" d="M0 51v537c0 29 23 52 51 52h457c28 0 51-23 51-51V210L370 0H51A51 51 0 000 51z"${3}/><path fill="#aacbff" d="M370 0l190 210H421a52 52 0 01-52-52l1-158z"${3}/><path fill="#014486" d="M370 159v10c0 28 23 52 52 52h138v-10H421a53 53 0 01-51-52z"${3}/><path fill="#fff" d="M235 467h-69c-4 0-8 3-8 8s3 8 8 8h69c4 0 8-3 8-8s-4-8-8-8zm-70-54h69c4 0 8-3 8-8 0-4-3-8-8-8h-69c-4 0-8 3-8 8 1 5 4 8 8 8zm-23 19c-4 0-8 3-8 8 0 4 3 8 8 8h115c4 0 8-3 8-8 0-4-3-8-8-8H142zm126-65a100 100 0 00-139 2 100 100 0 00-2 139c19 20 45 32 73 32h92c4 0 8-3 8-8v-92c0-28-11-54-32-73zm16 158h-84a86 86 0 01-62-27 84 84 0 0156-142h5c47 0 85 38 85 85v84z"${3}/></g>`;
function tmpl$d($api, $cmp, $slotset, $ctx) {
  const {st: api_static_fragment, h: api_element} = $api;
  return [api_element("svg", {
    className: $cmp.computedClass,
...
var doctype_quip_doc = registerTemplate(tmpl$d);
tmpl$d.stylesheets = [];
tmpl$d.stylesheetToken = "lwc-3ljnam9du40";
tmpl$d.legacyStylesheetToken = "buildTemplates-doctype_quip_doc";
freezeTemplate(tmpl$d);

const $fragment1$c = parseSVGFragment`<g${3}><path fill="#3ba755" d="M0 51v537c0 29 23 52 51 52h457c28 0 51-23 51-51V210L370 0H51A51 51 0 000 51z"${3}/><path fill="#cdefc4" d="M370 0l190 210H421a52 52 0 01-52-52l1-158z"${3}/><path fill="#22683e" d="M370 159v10c0 28 23 52 52 52h138v-10H421a53 53 0 01-51-52z"${3}/><path fill="#fff" d="M235 467h-69c-4 0-8 3-8 8s3 8 8 8h69c4 0 8-3 8-8s-4-8-8-8zm-70-54h69c4 0 8-3 8-8 0-4-3-8-8-8h-69c-4 0-8 3-8 8 1 5 4 8 8 8zm-23 19c-4 0-8 3-8 8 0 4 3 8 8 8h115c4 0 8-3 8-8 0-4-3-8-8-8H142zm126-65a100 100 0 00-139 2 100 100 0 00-2 139c19 20 45 32 73 32h92c4 0 8-3 8-8v-92c0-28-11-54-32-73zm-68 158a86 86 0 01-62-27 84 84 0 0156-142h5c47 0 85 38 85 85v84h-84z"${3}/></g>`;
function tmpl$c($api, $cmp, $slotset, $ctx) {
  const {st: api_static_fragment, h: api_element} = $api;
  return [api_element("svg", {
    className: $cmp.computedClass,
...
var doctype_txt = registerTemplate(tmpl$7);
tmpl$7.stylesheets = [];
tmpl$7.stylesheetToken = "lwc-3mcbbdp4ni6";
tmpl$7.legacyStylesheetToken = "buildTemplates-doctype_txt";
freezeTemplate(tmpl$7);

const $fragment1$6 = parseSVGFragment`<g${3}><path fill="#747474" d="M511 1A507 507 0 004 508v5384c0 280 227 508 507 508h4578c280 0 507-228 507-508V2032L3706 1z"${3}/><path fill="#5c5c5c" d="M5598 2035v100H4318s-631-126-613-671c0 1 21 571 600 571z"${3}/><path fill="#c9c9c9" d="M3707 0v1456c0 166 111 579 611 579h1280z"${3}/></g>`;
...
var doctype_xml = registerTemplate(tmpl$1);
tmpl$1.stylesheets = [];
tmpl$1.stylesheetToken = "lwc-20b6g6r1f9m";
tmpl$1.legacyStylesheetToken = "buildTemplates-doctype_xml";
...
var doctype_zip = registerTemplate(tmpl);
tmpl.stylesheets = [];
tmpl.stylesheetToken = "lwc-42f7fk123rc";
tmpl.legacyStylesheetToken = "buildTemplates-doctype_zip";
freezeTemplate(tmpl);
...
var iconSvgTemplatesDoctypeRtl = registerComponent(templates, {
  tmpl: _tmpl,
  sel: "lightning-icon-svg-templates-doctype-rtl",
  apiVersion: 61
});

export { iconSvgTemplatesDoctypeRtl as default };
