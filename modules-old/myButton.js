...
function stylesheet() {
  var shadowSelector = "";
  return ".my-class" + shadowSelector + " {background-color: green;}";
  /*LWC compiler v2.40.1*/
}
...
function tmpl($api, $cmp, $slotset, $ctx) {
  ...
  return [api_element("div", stc0, [api_text(api_dynamic_text($cmp.label))])];
  /*LWC compiler v2.40.1*/
}
...
tmpl.stylesheetToken = "my-button_button";
freezeTemplate(tmpl);
...
var MyButton$1 = registerComponent(MyButton, {
  tmpl: _tmpl,
  sel: "my-button"
});

customElements.define('my-button', MyButton$1.CustomElementConstructor);
