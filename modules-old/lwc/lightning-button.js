      ...
      case 'utility':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesUtilityRtl-ea9967f5.js');
          return Lib;
        }
      case 'action':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesActionRtl-6c920db0.js');
          return Lib;
        }
      case 'standard':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesStandardRtl-6b0c47a3.js');
          return Lib;
        }
      case 'doctype':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesDoctypeRtl-27afd6da.js');
          return Lib;
        }
      case 'custom':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesCustomRtl-f44bb0b6.js');
          return Lib;
        }
      default:
        return null;
      ...
      case 'utility':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesUtility-f73ca77f.js');
          return Lib;
        }
      case 'action':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesAction-48120dcc.js');
          return Lib;
        }
      case 'standard':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesStandard-d1d0019a.js');
          return Lib;
        }
      case 'doctype':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesDoctype-d578a119.js');
          return Lib;
        }
      case 'custom':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesCustom-caafbc19.js');
          return Lib;
        }
      default:
        return null;
...
export { _tmpl$2 as _, registerComponent as a, freezeTemplate as f, registerTemplate as r };
